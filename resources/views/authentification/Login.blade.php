                            ...
                            <div class="card-body">
                                <form class="needs-validation" method="post" action="ajouter-classe">
                                    ...
                                    <div class="position-relative mb-3">
                                        <label class="form-label" for="validationTooltip02">Matricule</label>
                                    ...
                                    <div class="position-relative mb-3">
                                        <label class="form-label" for="validationTooltipUsername">Mot de passe</label>
                                        <div class="input-group">
                                            {{-- <span class="input-group-text" id="validationTooltipUsernamePrepend">@</span> --}}
                                            <input type="text" class="form-control" id="validationTooltipUsername"
                                                placeholder="Mot de passe"
                                                aria-describedby="validationTooltipUsernamePrepend" required name="password">

                                        </div>
                                    </div>
                                    <div>
                                        <button class="btn btn-primary" type="submit">mot de passe oublié</button>
                                        <button class="btn btn-primary" type="submit" style="transform:translate(260px,0px)">connecter</button>
                                    </div>
                                </form>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
