...
<head>
  <meta charset="utf-8" />
  <title>Button Group | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Button Group</h4>
        </div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-xl-6">
              <div class="card">
                <div class="card-header">
                  ...
                  <p class="text-muted mb-0">Wrap a series of buttons with .btn in .btn-group.</p>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Mixed styles</h4>
                  <p class="text-muted mb-0">Wrap a series of buttons with .btn in .btn-group.</p>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Outlined styles</h4>
                  <p class="text-muted mb-0">Wrap a series of buttons with .btn in .btn-group.</p>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Checkbox and radio button groups </h4>
                  <p class="text-muted mb-0">Combine button-like checkbox and radio toggle buttons into a seamless
                    looking button group.</p>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-6">
              <div class="card">
                <div class="card-header">
                  ...
                  <p class="text-muted mb-0">Combine sets of button groups into button toolbars for more complex
            ...
            <div class="col-xl-6">
              <div class="card">
                <div class="card-header">
                  ...
                  <p class="text-muted mb-0">Place a .btn-group within another .btn-group when you want dropdown menus
            ...
            <div class="col-xl-6">
              <div class="card">
                <div class="card-header">
                  ...
                  <p class="text-muted mb-0">Make a set of buttons appear vertically stacked rather than horizontally.</p>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-6">
              <div class="card">
                <div class="card-header">
                  ...
                  <p class="text-muted mb-0">Instead of applying button sizing classes to every button in a group, just
                    add .btn-group-* to each .btn-group, including each one when nesting multiple groups.
                  </p>
                </div>
                <div class="card-body">
                  ...
                  <br>
                  <div class="btn-group mt-2 btn-group-sm" role="group" aria-label="Small button group">
                    <button type="button" class="btn btn-outline-primary">Left</button>
                    <button type="button" class="btn btn-outline-primary">Middle</button>
                    <button type="button" class="btn btn-outline-primary">Right</button>
                  </div>
