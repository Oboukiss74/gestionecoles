...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Grid System | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Grid System</h4>
        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class=".card-title mb-0">Grid Example</h4>
                                    </div>
                                    <div class="card-body">
