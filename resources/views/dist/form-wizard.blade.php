...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Form Wizard | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Form Wizard</h4>
        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control" id="userName" name="userName" value="Techmin">
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class=".card-title mb-0"> Button Wizard</h4>
                                    </div>
                                    <div class="card-body">
                                        <div id="btnwizard">
                                            <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="userName2" name="userName2" value="Techmin">
                                                                </div>
                                                            </div>
                                                            <div class="row mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class=".card-title mb-0"> Wizard With Form Validation</h4>
                                    </div>
                                    <div class="card-body">
                                        <div id="rootwizard">
                                                <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
