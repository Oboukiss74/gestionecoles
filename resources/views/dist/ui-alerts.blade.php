...
<head>
    <meta charset="utf-8" />
    <title>Alerts | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Alerts</h4>
        </div>
                                ...
                                <div class="card-body">
                                    <div class="alert alert-primary d-flex align-items-center" role="alert">
                                      ...
                                      <div class="alert alert-success d-flex align-items-center" role="alert">
                                        <i class="mdi mdi-check-circle-outline me-1 fs-16"></i>
                                        <div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted fs-14 mb-0">Click the button below to show an alert (hidden with inline styles to start), then dismiss (and destroy) it with the built-in close button.</p>
                                </div>
                                <div class="card-body">
