...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>List Group | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">List Group</h4>
        </div>
                                        ...
                                        <ol class="list-group list-group-numbered">
                                            <li
                                                ...
                                                <div class="ms-2 me-auto">
                                                    <div class="fw-bold">Techmin Admin</div>
                                                    Techmin Admin
                                                </div>
                                            ...
                                            <li
                                                class="list-group-item d-flex justify-content-between align-items-start">
                                                <div class="ms-2 me-auto">
                                                    <div class="fw-bold">Techmin React Admin</div>
                                                    Techmin React Admin
                                                </div>
