...
<head>
    <meta charset="utf-8" />
    <title>Lock Screen | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="p-4 my-auto">
                                        <div class="text-center w-75 m-auto">
                                            <img src="assets/images/users/avatar-1.jpg" height="64" alt="user-image" class="rounded-circle img-fluid img-thumbnail avatar-xl">
                                            <h4 class="text-center mt-3 fw-bold fs-20">Hi ! Adams </h4>
