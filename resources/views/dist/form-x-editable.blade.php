...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>X-Editable | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
        ...
        <!-- Plugins css -->
        <link href="assets/vendor/x-editable/bootstrap-editable.css" rel="stylesheet" type="text/css" />
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">X Editable</h4>
        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class=".card-title mb-4">Inline Examples</h4>
