...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Error 404 Alt | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Error 404 Alt</h4>
        </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="text-center">
                                        <img src="assets/images/svg/404.svg" alt="" class="img-fluid h-100 w-100">
                                        ...
                                        <a class="btn btn-soft-primary mt-3 w-100" href="index.html"><i class="ri-home-4-line me-1"></i> Back to Home</a>
                                    </div> <!-- end /.text-center-->
                                </div> <!-- end col-->
                            </div>
                        </div>
