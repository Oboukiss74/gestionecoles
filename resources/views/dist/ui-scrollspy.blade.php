...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Scrollspy | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Scrollspy</h4>
        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Scrollspy also works with nested <code>.nav</code>s. If a nested <code>.nav</code> is <code>.active</code>, its parents will also be <code>.active</code>. Scroll the area next to the navbar and watch the active class change.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4">
