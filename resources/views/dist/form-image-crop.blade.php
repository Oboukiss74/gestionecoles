...
<head>
    <meta charset="utf-8" />
    <title>Image Crop | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Image Crop</h4>
        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-9 img-crop-preview-btns docs-buttons">
                                            ...
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-secondary btn-sm" data-method="zoom"
                                            ...
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-secondary btn-sm" data-method="move"
                                            ...
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-secondary btn-sm" data-method="crop"
                                                    title="Crop">
                                                    <span class="docs-tooltip" data-bs-toggle="tooltip"
                                                ...
                                                <button type="button" class="btn btn-secondary btn-sm" data-method="clear"
                                                    title="Clear">
                                                    <span class="docs-tooltip" data-bs-toggle="tooltip"
                                                        data-bs-animation="false"
                                                        title="$().cropper(&quot;clear&quot;)">
                                            ...
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-secondary btn-sm" data-method="reset"
                                                    title="Reset">
                                                    <span class="docs-tooltip" data-bs-toggle="tooltip"
                                                        data-bs-animation="false"
                                                        title="$().cropper(&quot;reset&quot;)">
                                                ...
                                                <label class="btn btn-secondary mb-0 btn-upload btn-sm" for="inputImage"
