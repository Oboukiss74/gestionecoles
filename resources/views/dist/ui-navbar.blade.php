...
<head>
    <meta charset="utf-8" />
    <title>Navbar | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Navbar</h4>
        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">all the sub-components included in a responsive light-themed navbar that automatically collapses at the lg (large) breakpoint.</p>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Navbar-Dropdown</h4>
                                    <p class="text-muted mb-0">You can also use dropdowns in your navbar. Dropdown menus require a wrapping element for positioning, so be sure to use separate and nested elements for .nav-item and .nav-link as shown below.</p>
                                </div>
                                <div class="card-body">
                                    <nav class="navbar navbar-expand-lg bg-light">
                                        <div class="container-fluid">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Navbars may contain bits of text with the help of .navbar-text. This class adjusts vertical alignment and horizontal spacing for strings of text.</p>
                                </div>
                                <div class="card-body">
                                    <nav class="navbar navbar-expand-lg bg-light">
                                        <div class="container-fluid">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Transform your expanding and collapsing navbar into an offcanvas drawer with the offcanvas component. We extend both the offcanvas default styles and use our .navbar-expand-* classes to create a dynamic and flexible navigation sidebar. </p>
                                </div>
                                <div class="card-body">
