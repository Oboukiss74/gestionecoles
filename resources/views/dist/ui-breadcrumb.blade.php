...
<head>
    <meta charset="utf-8" />
    <title>Breadcrumb | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Breadcrumb</h4>
        </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">
                                        ...
                                        styled breadcrumb. Use our utilities to add additional styles as desired. <a
                                            target="_blank"
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-1 p-2 bg-light-subtle">
                                            <li class="breadcrumb-item active" aria-current="page"><i
                                                    class="mdi mdi-home-outline me-1"></i>Home</li>
                                        </ol>
                                    </nav>
