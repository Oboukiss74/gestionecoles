...
<head>
    <meta charset="utf-8" />
    <title>Carousel | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Carousel</h4>
        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted fs-14 mb-0">Add <code>.carousel-dark</code> to the
