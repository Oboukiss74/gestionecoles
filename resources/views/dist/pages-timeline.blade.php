...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Timeline | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Timeline</h4>
        </div>
                                            ...
                                            <article class="timeline-item">
                                                <div class="timeline-desk">
                                                    <div class="panel">
                                                        <div class="timeline-box">
                                                            <span class="arrow"></span>
                                                            <span class="timeline-icon bg-warning"><i class="mdi mdi-record-circle-outline"></i></span>
                                                ...
                                                <div class="timeline-desk">
                                                    <div class="panel">
                                                        <div class="timeline-box">
                                                            ...
                                                            <p class="timeline-date text-muted"><small>08:25 am</small></p>
                                                            <p>Download the new updates of Techmin admin dashboard</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </article>
                                            ...
                                            <article class="timeline-item">
                                                <div class="timeline-desk">
                                                    <div class="panel">
                                                        <div class="timeline-box">
                                                            <span class="arrow"></span>
                                                            <span class="timeline-icon bg-danger"><i class="mdi mdi-record-circle-outline"></i></span>
