...
<head>
    <meta charset="utf-8" />
    <title>Buttons | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button" class="btn btn-light"><i class="mdi mdi-cards-heart-outline"></i> </button>
                                        <button type="button" class="btn btn-danger"><i class="mdi mdi-window-closed-variant"></i> </button>
                                        <button type="button" class="btn btn-dark"><i class="mdi mdi-music-note-eighth"></i> </button>
                                        <button type="button" class="btn btn-primary"><i class="mdi mdi-shield-star"></i> </button>
                                        <button type="button" class="btn btn-success"><i class="mdi mdi-thumb-up-outline"></i> </button>
                                        <button type="button" class="btn btn-info"><i class="mdi mdi-keyboard-outline"></i> </button>
                                        <button type="button" class="btn btn-warning"><i class="mdi mdi-town-hall"></i> </button>

                                        <button type="button" class="btn btn-light"><i class="mdi mdi-heart-multiple me-1"></i> <span>Like</span> </button>
                                        <button type="button" class="btn btn-warning"><i class="mdi mdi-rocket me-1"></i> <span>Launch</span> </button>
                                        <button type="button" class="btn btn-info"><i class="mdi mdi-cloud-check-variant-outline me-1"></i> <span>Cloud Hosting</span> </button>

                                        <button type="button" class="btn btn-outline-success"><i class="mdi mdi-currency-gbp me-1"></i> Money</button>
                                        <button type="button" class="btn btn-outline-primary"><i class="mdi mdi-alpha-p-circle me-1"></i> PayPal</button>
                                        <button type="button" class="btn btn-outline-danger"><i class="mdi mdi-tune-variant me-1"></i> Settings</button>
                                    </div>
