...
<head>
    <meta charset="utf-8" />
    <title>Ratings | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Ratings</h4>
        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="card">
                               <div class="card-body">
                                    <h4 class="card-title">Icon Font - Change icon</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Progressive enhancement (using select)</h4>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Javascript interaction</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">Now we are in RTL mode. No changes needed to make this
                                        work</p>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                              <div class="card-body">
                                    <h4 class="card-title">Remix Icons</h4>
                                    <div class="rateit rateit-remix" data-rateit-mode="font"
                                        data-rateit-icon="&#xF18F;">
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Icon Font - Sizing</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Setting and Getting values</h4>
                                    <p class="text-muted">All properties can also be set on the fly. Here are a
                                        few examples:</p>
                                    <div class="rateit rateit-remix" data-rateit-mode="font" data-rateit-icon="&#xF18B;"
                                        id="getting-values">
                                    </div>
