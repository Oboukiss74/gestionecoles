...
<head>
    <meta charset="utf-8" />
    <title>Sparkline | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Sparkline</h4>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mt-4">
                                        <div id="sparkline1" data-colors="#007aff,#4489e4"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mt-4">
                                        <div id="sparkline2" data-colors="#007aff" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mt-4">
                                        <div id="sparkline3" data-colors="#007aff,#4489e4,#d03f3f,#716cb0"
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Custom Line Chart</h4>
                                </div>
                                <div class="card-body">
                                    <div class="mt-4">
                                        <div id="sparkline4" data-colors="#007aff,#716cb0" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Mouse Speed Chart</h4>
                                </div>
                                <div class="card-body">
                                    <div class="mt-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="text-center mt-4">
                                        <div id="sparkline6" data-colors="#f2f2f7,#007aff" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Discrete Chart</h4>
                                </div>
                                <div class="card-body">
                                    <div class="text-center mt-4">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="text-center mt-4" style="min-height: 164px;">
                                        <div id="sparkline9" data-colors="#007aff,#1a2942,#d1d7d973" class="text-center"></div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
                        </div> <!-- end col -->
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Tristate Charts</h4>
                                </div>
                                <div class="card-body">
                                    <div class="text-center mt-4" style="min-height: 164px;">
                                        <div id="sparkline10" data-colors="#d1d7d973,#1a2942,#007aff" class="text-center">
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end card -->
