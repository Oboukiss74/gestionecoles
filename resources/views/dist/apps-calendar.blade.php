...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Calendar | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
        ...
        <div class="d-flex align-items-center gap-1">
            ...
            <div class="logo-topbar">
                ...
                <a href="index.html" class="logo-light">
                    <span class="logo-lg">
                        <img src="{{ asset('{{ asset('assets/images/logo.png') }}') }}" alt="logo">
                    </span>
                    <span class="logo-sm">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Calendar</h4>
        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                ...
                                                <div id="external-events" class="mt-3">
                                                    ...
                                                    <div class="external-event rounded-0 bg-success-subtle text-success" data-class="bg-success"><i class="mdi mdi-record-circle me-2 vertical-middle"></i>New Theme Release</div>
                                                    <div class="external-event rounded-0 bg-info-subtle text-info" data-class="bg-info"><i class="mdi mdi-record-circle me-2 vertical-middle"></i>My Event</div>
                                                    <div class="external-event rounded-0 bg-warning-subtle text-warning" data-class="bg-warning"><i class="mdi mdi-record-circle me-2 vertical-middle"></i>Meet manager</div>
                                                    <div class="external-event rounded-0 bg-danger-subtle text-danger" data-class="bg-danger"><i class="mdi mdi-record-circle me-2 vertical-middle"></i>Create New theme</div>
                                                </div>
