...
<head>
    <meta charset="utf-8" />
    <title>Range Slider | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Range Slider</h4>
        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class=".card-title">Use Decorate Both option</h4>
