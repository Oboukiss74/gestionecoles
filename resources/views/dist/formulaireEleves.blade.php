                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom05"
                                                placeholder="Numero parents" required name="telephone">
                                        </div>
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate>
                                        ...
                                        <div class="position-relative mb-3">
                                            ...
                                            <select name="id_classe" class="form-control" id="validationTooltip03">
                                                <option value="">Sélectionnez le niveau suivant</option>
                                                @foreach ($niveau as $niveaux)
                                                    <option value="{{ $niveaux->id }}">{{ $niveaux->nom }}</option>
                                                @endforeach
                                                {{-- <option value="">Sélectionnez le niveau suivant</option>
                                            <option value="6e">6é</option>
                                            <option value="5e">5é</option>
                                            <option value="4e">4é</option>
                                            <option value="3e">3é</option>
                                        ...
                                        <div class="position-relative mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationTooltip05"
                                                placeholder="Numero des parents" required name="numero_parents">
