...
<head>
    <meta charset="utf-8" />
    <title>Responsive Table | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
    ...
    <link href="../assets/vendor/admin-resources/rwd-table/rwd-table.min.css" rel="stylesheet" type="text/css" />
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Responsive Table</h4>
        </div>
...
<!-- ========== Topbar End ========== -->
    ...
    <!-- Responsive Table js -->
    <script src="../assets/vendor/admin-resources/rwd-table/rwd-table.min.js"></script>
