...
<head>
    <meta charset="utf-8" />
    <title>Utilities | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Utilities</h4>
        </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Similar to the contextual text color classes, set the
                                        background of an element to any contextual class. Background
                                        utilities <strong>do not set <code>color</code></strong>, so in some cases
                                        you’ll want to use <code>.text-*</code>color utilities.</p>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">By adding a <code>.bg-gradient</code> class, a linear
                                        gradient is added as background image to the backgrounds. This
                                        gradient starts with a semi-transparent white which fades out to the bottom.</p>
                                </div>
                                <div class="card-body">
                                    <div class="p-2 mb-2 bg-primary bg-gradient text-white">.bg-gradient.bg-primary
                                    </div>
                                    <div class="p-2 mb-2 bg-secondary bg-gradient text-white">.bg-secondary.bg-gradient
                                    </div>
                                    <div class="p-2 mb-2 bg-success bg-gradient text-white">.bg-success.bg-gradient
                                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Similar to the contextual text color classes, set the
                                        background of an element to any contextual class. Background utilities do not
                                        set <code>color</code>, so in some cases you’ll want to use <code>.text-*</code>
                                        <a href="https://getbootstrap.com/docs/5.3/utilities/colors/">color
                                            utilities</a>.
                                    </p>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex flex-column gap-2">
                                                <div class="bg-primary-subtle p-2"><code
                                                        class="text-primary-emphasis">.text-primary-subtle</code></div>
                                                <div class="bg-secondary-subtle p-2"><code
                                                        class="text-secondary-emphasis">.bg-secondary-subtle </code>
                                                </div>
                                                ...
                                                <div class="bg-pink-subtle p-2"><code
                                                        class="text-pink-emphasis">.bg-pink-subtle</code></div>
                                                <div class="bg-purple-subtle p-2"><code
                                                        class="text-purple-emphasis">.bg-purple-subtle</code></div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Color and background helpers combine the power of our
                                        <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class.
                                        Using our Sass <code>color-contrast()</code> function, we automatically
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <div class="text-bg-success p-2">Success with contrasting color
                                            (.text-bg-success)</div>
                                        <div class="text-bg-danger p-2">Danger with contrasting color (.text-bg-danger)
                                        </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0"><code>background-color</code> utilities are generated
                                        with Sass using CSS variables. This
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-bg-primary p-2 bg-opacity-75">This is 75% opacity primary
                                        background</div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Colorize text with color utilities. If you want to
                                        colorize links, you can use the <code>.link-*</code> helper classes which have
                                        <code>:hover</code>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">text color utilities are generated with Sass using
                                            CSS variables. This allows for real-time color
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">The <code>opacity</code> property sets the opacity
                                            level for an element. The opacity level describes the transparency
                                            level, where <code>1</code> is not transparent at all, <code>.5</code> is
                                            50% visible, and <code>0</code> is
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Use border utilities to <b>add</b> an element’s
                                            borders. Choose from all borders or one at a time.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Use border utilities to <b>remove</b> an element’s
                                            borders. Choose from all borders or one at a time.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-start flex-wrap gap-4">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Change the border color using utilities built on our
                                            theme colors.</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">choose from any of the <code>.border-opacity</code>
                                            utilities:</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Add classes to an element to easily round its
                                            corners.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-start flex-wrap gap-2">
                                            <img src="assets/images/users/avatar-2.jpg" class="avatar-lg rounded"
                                                alt="rounded">
                                            <img src="assets/images/users/avatar-2.jpg" class="avatar-lg rounded-top"
                                                alt="rounded-top">
                                            <img src="assets/images/users/avatar-2.jpg" class="avatar-lg rounded-end"
                                                alt="rounded-end">
                                            <img src="assets/images/users/avatar-2.jpg" class="avatar-lg rounded-bottom"
                                                alt="rounded-bottom">
                                            <img src="assets/images/users/avatar-2.jpg" class="avatar-lg rounded-start"
                                                alt="rounded-start">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Use the scaling classes for larger or smaller rounded
                                            corners. Sizes range from <code>0</code> to <code>5</code>.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-start flex-wrap gap-2">
                                            <img src="assets/images/users/avatar-4.jpg" class="avatar-lg rounded-0"
                                                alt="rounded-0">
                                            <img src="assets/images/users/avatar-4.jpg" class="avatar-lg rounded-1"
                                                alt="rounded-1">
                                            <img src="assets/images/users/avatar-4.jpg" class="avatar-lg rounded-2"
                                                alt="rounded-2">
                                            <img src="assets/images/users/avatar-4.jpg" class="avatar-lg rounded-3"
                                                alt="rounded-3">
                                            <img src="assets/images/users/avatar-4.jpg" class="avatar-lg rounded-4"
                                                alt="rounded-4">
                                            <img src="assets/images/users/avatar-4.jpg" class="avatar-lg rounded-5"
                                                alt="rounded-5">
                                        </div>
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Use <code>user-select-all</code>,
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Bootstrap provides <code>.pe-none</code> and
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Adjust the <code>overflow</code> property on the fly
                                            with four default values and classes. These classes are not
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Arrange elements easily with the edge positioning
                                            utilities. The format is <code>{property}-{position}</code>.</p>
                                    </div>
                                    <div class="card-body">
                                        <!-- Arrange elements -->
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">In addition, you can also center the elements with
                                            the transform utility class <code>.translate-middle</code>.</p>
                                    </div>
                                    <div class="card-body">
                                        <!-- Center elements -->
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">While shadows on components are disabled by default
                                            in Bootstrap and can be enabled via
                                            <code>$enable-shadows</code>, you can also quickly add or remove a shadow
                                            with our <code>box-shadow</code> utility
                                            classes. Includes support for <code>.shadow-none</code> and three default
                                            sizes (which have associated variables to
                                            match).
                                        </p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Width utilities are generated from the utility API in
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Height utilities are generated from the utility API
                                            in <code>_utilities.scss</code>. Includes support for
                                            <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and
                                            <code>auto</code> by default. Modify
                                            those values as you need to generate different utilities here.
                                        </p>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="text-muted mb-0">Change the value of the <a
                                                ...
                                                property</a> with our responsive <code>object-fit</code> utility
                                            classes. This property tells the content to fill the parent container in a
                                            variety of ways, such as preserving the aspect ratio or stretching to take
                                            up as much space as possible.</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                                            <div>
                                                ...
                                                <p class="mt-1 mb-0"><code
                                                        class="user-select-all">.object-fit-contain</code></p>
                                            </div>
                                            <div>
                                                <img src="assets/images/small/small-1.jpg"
                                                    class="object-fit-cover border rounded avatar-xl" alt="...">
                                                <p class="mt-1 mb-0"><code
                                                        class="user-select-all">.object-fit-cover</code></p>
                                            </div>
                                            <div>
                                                <img src="assets/images/small/small-1.jpg"
                                                    class="object-fit-fill border rounded avatar-xl" alt="...">
                                                <p class="mt-1 mb-0"><code
                                                        class="user-select-all">.object-fit-fill</code></p>
                                            </div>
                                            <div>
                                                <img src="assets/images/small/small-1.jpg"
                                                    class="object-fit-scale border rounded avatar-xl" alt="...">
                                                <p class="mt-1 mb-0"><code
                                                        class="user-select-all">.object-fit-scale</code></p>
                                            </div>
                                            <div>
                                                <img src="assets/images/small/small-1.jpg"
                                                    class="object-fit-none border rounded avatar-xl" alt="...">
                                                <p class="mt-1 mb-0"><code
                                                        class="user-select-all">.object-fit-none</code></p>
                                            </div>
                                        </div>
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
