...
<head>
    <meta charset="utf-8" />
    <title>Tooltips | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Tooltips</h4>
        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Custom tooltips</h4>
                                    <p class="text-muted mb-0">You can customize the appearance of tooltips using CSS variables. We set a custom class with data-bs-custom-class="custom-tooltip" to scope our custom appearance and use it to override a local CSS variable.</p>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted fs-14 mb-0">Hover over the buttons below to see the four tooltips directions: top, right, bottom, and left. Directions are mirrored when using Bootstrap in RTL.</p>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Tooltip on top" data-bs-custom-class="primary-tooltip" >
                                            Tooltip on top
                                          </button>
                                          <button type="button" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Tooltip on right" data-bs-custom-class="danger-tooltip">
                                            Tooltip on right
                                          </button>
                                          <button type="button" class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Tooltip on bottom"  data-bs-custom-class="info-tooltip" >
                                            Tooltip on bottom
                                          </button>
                                          <button type="button" class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Tooltip on left" data-bs-custom-class="success-tooltip">
                                            Tooltip on left
                                          </button>
                                    </div>
                                </div> <!-- end card-body -->
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted fs-14 mb-0">We set a custom class with ex. <code>data-bs-custom-class="primary-tooltip"</code> to scope our background-color primary appearance and use
