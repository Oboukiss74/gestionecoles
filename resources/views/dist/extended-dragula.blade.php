...
<head>
    <meta charset="utf-8" />
    <title>Dragula | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Dragula</h4>
        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Simple Drag and Drop Example</h4>
                                    <p class="text-muted">
                                        Just specify the data attribute <code>data-plugin='dragula'</code> to have drag
                                        and drop support in your container.
                                    </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Move stuff between containers</h4>
                                    <p class="text-muted">
                                                            ...
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="w-100 overflow-hidden">
                                                                    ...
                                                                    <p class="mb-0 text-muted">
                                                                        <span class="fst-italic"><b>"</b>Disrupt pork
                                                                            belly poutine, asymmetrical tousled
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Move stuff between containers using handle</h4>
                                    <p class="text-muted">
                                        Just specify the data attribute
