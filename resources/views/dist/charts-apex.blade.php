...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Apex Charts | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Apex Charts</h4>
        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="basic-area" class="apex-charts" data-colors="#007aff"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="spline-area" class="apex-charts" data-colors="#007aff,#000000"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Basic Boxplot</h4>
                                    </div>
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="basic-boxplot" class="apex-charts" data-colors="#007aff,#47ad77"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Scatter Boxplot </h4>
                                    </div>
                                    <div class="card-body">
                                        <div dir="ltr">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="simple-bubble" class="apex-charts" data-colors="#007aff,#edc755,#fa5c7c"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="second-bubble" class="apex-charts" data-colors="#007aff,#47ad77,#fa5c7c,#39afd1"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            ...
                                            <div id="combo-bar-candlestick" class="apex-charts" data-colors="#007aff,#edc755"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="basic-column" class="apex-charts" data-colors="#007aff,#4489e4,#33b0e0"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="datalabels-column" class="apex-charts" data-colors="#007aff"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Simple line chart</h4>
                                    </div>
                                    <div class="card-body">
                                        <div dir="ltr">
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="line-chart-datalabel" class="apex-charts" data-colors="#d03f3f,#007aff"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="line-column-mixed" class="apex-charts" data-colors="#4489e4,#007aff"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="multiple-yaxis-mixed" class="apex-charts" data-colors="#007aff,#39afd1,#fa5c7c"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="simple-pie" class="apex-charts" data-colors="#007aff,#6c757d,#4489e4,#d03f3f,#edc755"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="simple-donut" class="apex-charts" data-colors="#007aff,#6c757d,#4489e4,#d03f3f,#edc755"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="basic-polar-area" class="apex-charts" data-colors="#007aff,#6c757d,#4489e4,#d03f3f,#edc755,#33b0e0"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Monochrome Polar Area</h4>
                                    </div>
                                    <div class="card-body">
                                        <div dir="ltr">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Radar with Polygon-fill</h4>
                                    </div>
                                    <div class="card-body">
                                        <div dir="ltr">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="basic-radialbar" class="apex-charts" data-colors="#007aff"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div dir="ltr">
                                            <div id="multiple-radialbar" class="apex-charts" data-colors="#007aff,#4489e4,#edc755,#33b0e0"></div>
                                        </div>
                                    </div>
                                    <!-- end card body-->
                                </div>
