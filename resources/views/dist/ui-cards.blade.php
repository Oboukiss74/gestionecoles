...
<head>
    <meta charset="utf-8" />
    <title>Cards | Techmin - Bootstrap 5 Admin & Dashboard Template</title>
...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <!-- Page Title -->
            <h4 class="page-title d-none d-sm-block">Cards</h4>
        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card-group">
                                ...
                                <div class="card d-block">
                                    <img class="card-img-top" src="assets/images/small/small-6.jpg"
                                        alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Card title</h5>
                                        <p class="card-text">This is a wider card with supporting text below as a
