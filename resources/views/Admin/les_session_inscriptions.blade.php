                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarLayouts">
                            <ul class="side-nav-second-level">
                                ...
                                <li class="side-nav-item">
                                    <a class="side-nav-link" href="layouts-unsticky-layout.html" target="_blank">Unsticky
                                        Layout</a>
                                </li>
                                <li class="side-nav-item">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class=".card-title mb-4">Les sessions d'inscription</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($session->statut === 'fermee')
                                                                <form action="{{ route('modifier.session_inscription', $session->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    {{-- <button type="button" class="btn btn-sm btn-outline-secondary" onclick="window.location='{{ route('modifier.session_inscription', $session->id) }}'">ouvrir</button> --}}
                                                            ...
                                                            @else
                                                                <form action="{{ route('modifier.session_inscription', $session->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    {{-- <button type="button" class="btn btn-sm btn-outline-secondary" onclick="window.location='{{ route('modifier.session_inscription', $session->id) }}'">fermer</button> --}}
