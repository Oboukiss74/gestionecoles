            ...
            <div class="container-fluid" style="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6" style="transform: translate(55%, 10px);">
                        <div class="card">
                            @if (session('successannee'))
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    {{ session('successannee') }}
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                                        aria-label="Close"></button>
                                </div>
                            @endif
                            <div class="card-header">
                                <h4 class=".card-title">Ajout des années scolaires</h4>
                            ...
                            <div class="card-body">
                                <form class="needs-validation" method="post" action="{{ route('enregistrer_annee_scolaire') }}">
                                    @csrf
                                    ...
                                    <div class="position-relative mb-3">
                                        <label class="form-label" for="validationTooltipUsername">libelle</label>
                                        <div class="input-group">
                                            {{-- <span class="input-group-text" id="validationTooltipUsernamePrepend">@</span> --}}
                                            <input type="text" class="form-control" id="validationTooltipUsername"
                                                placeholder="libelle" aria-describedby="validationTooltipUsernamePrepend"
