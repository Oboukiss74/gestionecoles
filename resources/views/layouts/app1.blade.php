        ...
        <div class="content">
            ...
            {{-- <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class=".card-title mb-0">Select & Switches</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <h4 class=".card-title mt-5 mt-lg-0">Switches</h4>
                                            <p class="text-muted fs-14">
            ...
            {{-- <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class=".card-title mt-5 mt-lg-0">Checkboxes </h4>
                                    <p class="text-muted mb-0">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class=".card-title mt-5 mt-lg-0">radios</h4>
                                    <p class="text-muted mb-0">
                                        Each checkbox and radio <code>&lt;input&gt;</code> and
                                        <code>&lt;label&gt;</code> pairing is wrapped in a <code>&lt;div&gt;</code> to
                                        create our custom control. Structurally, this is the same approach as our
