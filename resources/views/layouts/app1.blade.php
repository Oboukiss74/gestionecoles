            ...
            <div class="topbar container-fluid">
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    ...
                    @guest
                        ...
                        <a class="nav-link dropdown-toggle arrow-none" href="{{ route('login') }}" role="button"
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown"
                                ...
                                <span class="d-lg-block d-none">
                                    <h5 class="my-0 fw-normal">{{ strtoupper(substr(Auth::user()->eleve->nom, 0, 1)) }}
                                        {{ strtoupper(substr(Auth::user()->eleve->prenom, 0, 1)) }}<i
            ...
            <div class="leftside-menu">
                ...
                <div data-simplebar>
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="{{ route('eleves.profile') }}">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarPagesAuth">
                                <ul class="side-nav-second-level">
                                    ...
                                    @auth
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ route('Deconnexion') }}">Deconnexion</a>
                                        </li>
                                        <li class="side-nav-item">
                                            <a class="side-nav-link" href="{{ route('password.request') }}">Mot de passe
                                                oublié</a>
                                        </li>
                                        {{-- <li class="side-nav-item">
                                            <a class="side-nav-link" href="{#">Reinitialisation du mot de passe</a>
                                        </li> --}}
                                    @endauth
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarLayouts">
                                <ul class="side-nav-second-level">
                                    <li class="side-nav-item">
                                        <a class="side-nav-link" href="#" target="_blank">Light
                                            Sidebar</a>
                                    </li>
                                    <li class="side-nav-item">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link" href="layouts-collapsed-sidebar.html"
                                            target="_blank">Collapsed Sidebar</a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a class="side-nav-link" href="layouts-unsticky-layout.html"
                                            target="_blank">Unsticky Layout</a>
                                    </li>
                                    <li class="side-nav-item">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarForms">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link" href="{{ route('ajouter_une_matiere') }}">Ajouter
                                            matieres</a>
                                    ...
                                    <li class="side-nav-item">
                                        <a class="side-nav-link"
                                            href="{{ route('programmer.inscription.create') }}">creer inscription</a>
                                    </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarForms">
                                <ul class="side-nav-second-level">
                                    {{-- <li class="side-nav-item">
                                        <a class="side-nav-link" href="{{ route('inscription_create') }}">Programmer une inscription</a>
                                    </li> --}}
                                    <li class="side-nav-item">
                                        <a class="side-nav-link" href="{{ route('les_sessions_inscriptions') }}">les
                                            inscriptions</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="side-nav-item">
                            <a class="side-nav-link" href="#">Form
                                Editors</a>
                        </li>

                        <li class="side-nav-item">
                            <a class="side-nav-link" href="#">liste
                                des classes</a>
                        </li>
                    </ul>
                </div>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarTables">
                        <ul class="side-nav-second-level">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="#">Basic
                                    Tables</a>
                            </li>
                            <li class="side-nav-item">
                            ...
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="#">Data
                                    Tables</a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="#">Editable Tables</a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="#">Responsive Table</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarMaps">
                        <ul class="side-nav-second-level">
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="#">Google
                                    Maps</a>
                            </li>
                            <li class="side-nav-item">
                                <a class="side-nav-link" href="#">Vector
                                    Maps</a>
                            </li>
                        </ul>
                    </div>
