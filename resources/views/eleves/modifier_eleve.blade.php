            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class=".card-title">Flatpickr - Date picker</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class=".card-title">Flatpickr - Time Picker </h4>
                                <p class="text-muted mb-0">A lightweight and powerful datetimepicker</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter money"
                                                    data-toggle="input-mask" data-mask-format="000.000.000.000.000,00"
                                                    data-reverse="true">
                                    ...
                                    <div class="col-md-6">
                                        <form action="#">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter telephone"
                                                    data-toggle="input-mask" data-mask-format="(00) 00000-0000">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter IP address"
                                                    data-toggle="input-mask" data-mask-format="099.099.099.099"
                                                    data-reverse="true">
