                                ...
                                <div class="col-lg-3  d-none d-lg-block">
                                    ...
                                    <div class="pt-3 ps-2">
                                        <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span
                                                class="ms-2">Adams A. Franklin</span></p>
                                ...
                                <div class="col-lg-9 bg-light-subtle">
                                    <div class="profile-content">
                                        <div class="nav nav-pills nav-justified gap-0 p-3 text-center" id="v-pills-tab"
                                            ...
                                            <li class="nav-item mt-2"><a class="nav-link fs-5 p-2 active"
                                                    type="button"
                                                    role="tab" aria-controls="home" aria-selected="true"
                                                    href="{{ route('inscriptiontest') }}">S'inscrire</a>
                                                {{-- @if (!estInscrit(auth()->id()))
                                                    <button class="btn btn-primary nav-link fs-5 p-2 active">S'inscrire</button>
                                                @endif --}}
                                            </li>
                                            {{-- <li class="nav-item mt-2"><a class="nav-link fs-5 p-2"
                                                        data-bs-toggle="tab" data-bs-target="#user-activities"
                                                        type="button" role="tab" aria-controls="home"
                                                        aria-selected="true" href="#user-activities">Activities</a>
                                                </li>
                                                <li class="nav-item mt-2"><a class="nav-link fs-5 p-2"
                                                        data-bs-toggle="tab" data-bs-target="#edit-profile"
                                                        type="button" role="tab" aria-controls="home"
                                                        aria-selected="true" href="#edit-profile">Settings</a></li>
                                                <li class="nav-item mt-2"><a class="nav-link fs-5 p-2"
                                                        data-bs-toggle="tab" data-bs-target="#projects"
                                                        type="button" role="tab" aria-controls="home"
                                                        aria-selected="true" href="#projects">Projects</a></li> --}}
                                        ...
                                        <div class="tab-content m-0 p-2 p-sm-4 " id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane active" id="aboutme" role="tabpanel"
                                                ...
                                                <div class="profile-desk">
                                                    ...
                                                    <div class="designation mb-3">PRODUCT DESIGNER (UX / UI /
                                                        Visual
                                                        Interaction)</div>
                                                ...
                                                <div class="timeline-2">
                                                    ...
                                                    <div class="time-item">
                                                        <div class="item-info ms-3 mb-3">
                                                            ...
                                                            <p><a href="" class="text-info">Lorem</a>
                                                                commented your
                                                                post.
                                                            </p>
                                                    ...
                                                    <div class="time-item">
                                                        <div class="item-info ms-3 mb-3">
                                                            ...
                                                            <p><a href="" class="text-info">Jessi</a>
                                                                attended a meeting
                                                                with<a href="#" class="text-success">John
                                                                    Doe</a>.</p>
                                                            <p><em>"Lorem ipsum dolor sit amet, consectetur
                                                                    adipiscing
                                                                    elit.
                                                    ...
                                                    <form>
                                                        <div class="row row-cols-sm-2 row-cols-1">
                                                            ...
                                                            <div class="col-sm-12 mb-3">
                                                                <label class="form-label" for="AboutMe">About
                                                                    Me</label>
                                                                <textarea style="height: 125px;" id="AboutMe" class="form-control">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</textarea>
                                                            </div>
                                                        </div>
                                                        <button class="btn btn-primary" type="submit"><i
                                                                class="mdi mdi-content-save-outline me-1 fs-16 lh-1"></i>
                                                            Save</button>
                                                    </form>
                                                </div>
                                            </div>
