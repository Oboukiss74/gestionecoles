                                    ...
                                    <table class="table mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">lieux de naissance</th>
                                        ...
                                        <tbody>
                                            @foreach ($eleves as $eleve)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- Modifier -->
                                                        <a href="{{ route('eleves.edit', $eleve->id) }}" class="btn btn-sm btn-outline-primary">
                                                            <i class="fa fa-edit"></i>
                                                        </a>

                                                        <!-- Voir -->
                                                        <a href="{{ route('eleves.liste', $eleve->id) }}" class="btn btn-sm btn-outline-info">
                                                            <i class="fa fa-eye"></i>
                                                        </a>

                                                        <!-- Supprimer -->
                                                        <a href="{{ route('eleves.destroy', $eleve->id) }}" class="btn btn-sm btn-outline-danger">
